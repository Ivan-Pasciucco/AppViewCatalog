		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapdemoappviewappviewcatalog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdemoappviewappviewcatalog-display": {
								"semanticObject": "sapdemoappviewappviewcatalog",
								"action": "display",
								"description": "Aplicacion con catalogo de vistas",
								"title": "App View Catalog",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.demo.appview.appviewcatalog",
									"url": sap.ui.require.toUrl("sap/demo/appview/appviewcatalog")
								}
							}
						}
					}
